...
def get_args_parser():
    ...
    parser.add_argument('--debug-data',default=False,action="store_true")
    # Model
    ...
    parser.add_argument("--no-text", default=False,action="store_true")
    ...
    with torch.no_grad():
        ...
        for i, (pc, target, target_name) in enumerate(test_loader):
            ...
            for idx, name in enumerate(target_name):
                ...
                #     print(correct.shape)
                #     print(top1_accurate.shape)
                #     print(top5_accurate.shape)
                #     print()
